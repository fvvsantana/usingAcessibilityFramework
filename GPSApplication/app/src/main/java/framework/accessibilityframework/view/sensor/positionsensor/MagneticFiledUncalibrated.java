 ...
 */
public class MagneticFiledUncalibrated extends AppCompatActivity implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent event) {
        ...
        if (sensor.getType() == Sensor.TYPE_MAGNETIC_FIELD_UNCALIBRATED){
            workWithMagneticFieldUncalibratedSensor(event);
        }
    }
    ...
    protected void onResume() {
        ...
        try{
            magneticFieldUncalibrated = facade.getSensorInstance(sensorManager, Sensor.TYPE_MAGNETIC_FIELD_UNCALIBRATED);
    ...
    protected void workWithMagneticFieldUncalibratedSensor(SensorEvent event){}
}
